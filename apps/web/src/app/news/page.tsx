    ...
    <div className="space-y-8">
      ...
      {data && data.batches.length === 0 && (
        <p className="text-sm text-navy-800/60">
          {isAdmin
            ? 'هنوز خبری ثبت نشده. در ساعتی که مدیر گذاشته خودکار می‌آید؛ یا دکمه «به‌روزرسانی اخبار» را بزنید.'
            : 'هنوز خبری در سیستم ثبت نشده است. جمع‌آوری بعدی در ساعت تنظیم‌شده است.'}
        </p>
      )}
