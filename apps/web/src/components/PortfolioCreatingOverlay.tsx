    ...
    >
      <div className="relative w-full max-w-md overflow-hidden rounded-2xl border border-navy-900/10 bg-cream px-6 py-8 shadow-soft">
        ...
        <div className="relative flex flex-col items-center text-center">
          ...
          <h2 className="text-lg font-semibold text-navy-900">در حال تشکیل سبد</h2>
          <p className="mt-2 text-sm leading-7 text-navy-800/75">
            سبد با سرمایه و استراتژی انتخابی، بر اساس آخرین درس‌آموخته‌ها، اخبار، دادهٔ بازار و
            صندوق‌ها در حال تشکیل است. لطفاً صبر کنید.
          </p>
          ...
          <div className="mt-5 flex min-h-[1.75rem] items-center justify-center gap-2">
            ...
            <span
              key={step}
              className="portfolio-create-fade text-sm font-medium text-navy-800"
            >
              {STEPS[step]}
            </span>
          </div>
