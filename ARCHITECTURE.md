...
4. **اخبار و فرصت‌ها:** هر روز ۸:۰۰ تهران فید شبکهٔ X برای اقتصاد ایران خوانده می‌شود (نه قیمت دلار/طلای دیتابیس) و مدل فقط از همان پست‌ها خبر می‌سازد. راس ۸:۳۰ به هر کاربر وصل‌شده تلگرام، نمودار سبد جاری، پیشنهاد بهبود با قیمت بورس و نرخ ارز و اخبار، و خلاصهٔ فرصت‌ها فرستاده می‌شود. ربات عمومی:
