...
- آزمایش گراف فارکس در `/forex`: ذخیرهٔ رأس/یال نرخ جفت‌ارز و فلز/رمزارز با زمان، رسم تعاملی، سیگنال لانگ/شورت با اختلاف حداقل ۳٪
- گفتگوی LLM در صفحهٔ بازار سهام تهران: فقط نماد/شاخص بورس تهران با دادهٔ قیمت و صندوق‌هایی که سهم را خریده‌اند
- اقتصاد دنیا: همگام‌سازی روزانهٔ همهٔ نمادهای بیت‌پین راس ۷ صبح تهران، صفحهٔ ادمین با به‌روزرسانی فوری
